    ...
    <section id="about-us" className="py-12 md:py-16 px-5 md:px-8 bg-[#FAF8F4]">
      <div className="max-w-[1400px] mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-h2 font-bold text-[#14181D] mb-3">Our Journey</h2>
              ...
              return (
                <div key={idx} className="flex flex-col items-center text-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#22282F] leading-relaxed max-w-[250px] mx-auto">
                      {item.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex gap-3.5 items-start p-6 bg-white rounded-[6px] border border-gray-200 shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-[#22282F] leading-relaxed">
                {siteData.vision}
              </p>
            </div>
          </div>
