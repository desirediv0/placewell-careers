...
export default function About() {
  ...
  return (
    <section id="about-us" className="py-12 md:py-16 px-5 md:px-8 bg-[#F8FAFC]">
      <div className="max-w-[1400px] mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-3">
            <div className="w-8 h-[2px] bg-[#1D4ED8]" />
            <span className="text-[#1D4ED8] text-sm font-semibold tracking-wider uppercase">About Us</span>
            <div className="w-8 h-[2px] bg-[#1D4ED8]" />
          </div>
          <h2 className="text-h2 font-bold text-[#0f172a] mb-3">Our Journey</h2>
