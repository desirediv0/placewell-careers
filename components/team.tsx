  ...
  return (
    <section id="team" className="py-12 md:py-16 px-5 md:px-8 bg-white">
      <div className="max-w-[1400px] mx-auto">
          ...
          {siteData.team.map((member, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute top-0 left-0 right-0 h-0.5 bg-[#0E6F66] transition-all duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'}`} />
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-sm font-medium text-[#0E6F66] hover:text-[#0A5A52] transition-colors">
        ...
        <div className="mt-12 bg-[#FAF8F4] border border-gray-200 rounded-[6px] p-8 md:p-10">
