      ...
      <div className="max-w-3xl mx-auto">
        ...
        {submitted ? (
          <div className="p-10 bg-white border border-[#0E6F66] rounded-[6px] text-center">
            ...
            <h3 className="text-xl font-bold text-[#14181D] mb-2">Thank You</h3>
            <p className="text-sm text-[#22282F]">We&apos;ll be in touch shortly with more information.</p>
          </div>
        ) : (
          <form
          ...
          >
            ...
            {/* Name */}
            <div>
              <label className="block text-sm font-semibold text-[#14181D] mb-1.5">Full Name</label>
              <input
                {...register('name', { required: 'Name is required' })}
                type="text"
                suppressHydrationWarning
                className="w-full h-[44px] px-4 bg-white border border-gray-200 text-[#14181D] placeholder:text-[#9AA1AC] focus:outline-none focus:border-[#2F68AB] rounded-[6px] transition-colors text-sm"
            ...
            {/* Email */}
            <div>
              <label className="block text-sm font-semibold text-[#14181D] mb-1.5">Email</label>
              <input
                {...register('email', {
            ...
            {/* Phone */}
            <div>
              <label className="block text-sm font-semibold text-[#14181D] mb-1.5">Phone</label>
              <input
            ...
            {/* Subject */}
            <div>
              <label className="block text-sm font-semibold text-[#14181D] mb-1.5">Subject</label>
              <input
            ...
            {/* Message */}
            <div>
              <label className="block text-sm font-semibold text-[#14181D] mb-1.5">Message</label>
              <textarea
                {...register('message', { required: 'Message is required' })}
                rows={4}
                suppressHydrationWarning
                className="w-full px-4 py-3 bg-white border border-gray-200 text-[#14181D] placeholder:text-[#9AA1AC] focus:outline-none focus:border-[#2F68AB] rounded-[6px] transition-colors resize-none text-sm"
            ...
            {/* CV Upload */}
            <div>
              <label className="block text-sm font-semibold text-[#14181D] mb-1.5">Upload CV (Optional)</label>
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm text-[#3B434C]">
