        ...
        <div className="relative z-10 w-full pb-16 px-5 md:px-8">
          <div className="max-w-[1400px] mx-auto">
            ...
            <motion.h1
              ...
              className="text-h1 font-bold text-white leading-[1.1] mb-4"
            >
            ...
            <motion.p
              ...
              className="text-body-lg text-[#b8c7de] max-w-lg"
            >
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 mb-5">
              ...
              <span className="text-[#1D4ED8] text-sm font-semibold tracking-wider uppercase">Why Placewell?</span>
              <div className="w-8 h-[2px] bg-[#1D4ED8]" />
            </div>
            ...
            {benefits.map((benefit, idx) => (
              ...
              >
                <div className="w-12 h-12 bg-[#EFF6FF] rounded-lg flex items-center justify-center mb-4">
                  <benefit.icon size={24} className="text-[#1D4ED8]" />
                </div>
                <h3 className="text-body-lg font-bold text-[#0f172a] mb-2">{benefit.title}</h3>
                <p className="text-[#64748b]">{benefit.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="lg:sticky lg:top-28">
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-[#1D4ED8] text-sm font-semibold tracking-wider uppercase">Drop Your CV</span>
              </div>
              ...
              <div className="bg-white rounded-[6px] p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-4">
                  <Target size={20} className="text-[#1D4ED8]" />
                  <h3 className="text-body font-bold text-[#0f172a]">Sectors We Recruit For</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {['BFSI', 'Fintech', 'Healthcare', 'Hospitality', 'IT/EdTech', 'Manufacturing'].map((sector) => (
                    <span key={sector} className="px-3 py-1.5 bg-[#f8fafc] border border-gray-200 text-sm text-[#475569] rounded-full">
                      {sector}
                    </span>
                  ))}
                </div>
      ...
      <section className="py-12 md:py-16 px-5 md:px-8 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 mb-5">
              <div className="w-8 h-[2px] bg-[#1D4ED8]" />
              <span className="text-[#1D4ED8] text-sm font-semibold tracking-wider uppercase">Visit Us</span>
              <div className="w-8 h-[2px] bg-[#1D4ED8]" />
            </div>
            <h2 className="text-2xl md:text-4xl font-bold text-[#0f172a] mb-4">
              Our Office Network
