          ...
          <div style="background: #FAF8F4; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #E6E2DB; border-top: none;">
            <div style="background: white; padding: 24px; border-radius: 8px; border: 1px solid #E6E2DB; margin-bottom: 20px;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                ${company ? `
                <tr>
                  <td style="padding: 8px 0; color: #6B7480; font-weight: 500;">Company:</td>
                  <td style="padding: 8px 0; color: #2B3138; font-weight: 500;">${company}</td>
                </tr>` : ''}
                <tr>
                ...
                <tr>
                  <td style="padding: 8px 0; color: #6B7480; font-weight: 500;">Service:</td>
                  <td style="padding: 8px 0; color: #2B3138; font-weight: 500;">${serviceLabel}</td>
                </tr>
              </table>
            </div>
            ...
            <div style="background: white; padding: 24px; border-radius: 8px; border: 1px solid #E6E2DB; margin-bottom: 20px;">
              ...
              <p style="margin: 0; color: #4A525C; white-space: pre-wrap;">${requirement}</p>
            </div>
            ...
            <div style="background: white; padding: 24px; border-radius: 8px; border: 1px solid #E6E2DB;">
              ...
              <p style="margin: 0; color: #4A525C; white-space: pre-wrap;">${message}</p>
            </div>
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #2B3138; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #FAF8F4; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #E6E2DB; border-top: none;">
            ...
            <p style="color: #4A525C;">Thank you for reaching out to Placewell Careers. We have received your enquiry regarding <strong>${serviceLabel}</strong> and our team will review your requirements.</p>
            <p style="color: #4A525C;">Our recruitment specialists will get back to you within <strong>24 hours</strong> during business hours (Mon-Fri, 9:30 AM - 6:30 PM).</p>
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #E6E2DB; margin: 24px 0;">
              ...
              <p style="margin: 4px 0; color: #4A525C;"><strong>Service:</strong> ${serviceLabel}</p>
              <p style="margin: 4px 0; color: #4A525C;"><strong>Requirement:</strong> ${requirement}</p>
            </div>

            <p style="color: #6B7480; font-size: 14px;">For urgent hiring requirements, you can also reach us directly at:</p>
