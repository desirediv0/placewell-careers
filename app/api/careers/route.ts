  ...
  try {
    ...
    const emailHtml = `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #2B3138; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #FAF8F4; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #E6E2DB; border-top: none;">
            <div style="background: white; padding: 24px; border-radius: 8px; border: 1px solid #E6E2DB; margin-bottom: 20px;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  <td style="padding: 8px 0; color: #6B7480; font-weight: 500; width: 140px;">Name:</td>
                  <td style="padding: 8px 0; color: #2B3138; font-weight: 500;">${name}</td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #6B7480; font-weight: 500;">Email:</td>
                  <td style="padding: 8px 0; color: #2B3138; font-weight: 500;"><a href="mailto:${email}" style="color: #0E6F66; text-decoration: none;">${email}</a></td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #6B7480; font-weight: 500;">Phone:</td>
                  <td style="padding: 8px 0; color: #2B3138; font-weight: 500;"><a href="tel:${phone}" style="color: #0E6F66; text-decoration: none;">${phone}</a></td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #6B7480; font-weight: 500;">Position:</td>
                  <td style="padding: 8px 0; color: #2B3138; font-weight: 500;">${position}</td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #6B7480; font-weight: 500;">Experience:</td>
                  <td style="padding: 8px 0; color: #2B3138; font-weight: 500;">${experience}</td>
                </tr>
              </table>
            </div>
            ...
            <div style="background: white; padding: 24px; border-radius: 8px; border: 1px solid #E6E2DB; margin-bottom: 20px;">
              ...
              <p style="margin: 0 0 16px 0; color: #4A525C;">The candidate's CV has been uploaded to secure storage.</p>
              ...
              <p style="margin: 12px 0 0 0; font-size: 12px; color: #98A0AB;">Link expires in 7 days. File: ${cv.name} (${(cv.size / 1024).toFixed(1)} KB)</p>
            </div>
          ...
          <p style="text-align: center; color: #98A0AB; font-size: 12px; margin-top: 20px;">
    ...
    const userEmailHtml = `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #2B3138; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #FAF8F4; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #E6E2DB; border-top: none;">
            <p style="color: #4A525C; font-size: 16px;">Dear ${name},</p>
            <p style="color: #4A525C;">Thank you for submitting your CV for the <strong>${position}</strong> position. We have received your application and our recruitment team will review your profile.</p>
            <p style="color: #4A525C;">If your experience matches our current or upcoming requirements, we will reach out to you within <strong>5-7 business days</strong>.</p>
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #E6E2DB; margin: 24px 0;">
              ...
              <p style="margin: 4px 0; color: #4A525C;"><strong>Position:</strong> ${position}</p>
              <p style="margin: 4px 0; color: #4A525C;"><strong>Experience:</strong> ${experience}</p>
              <p style="margin: 4px 0; color: #4A525C;"><strong>CV:</strong> ${cv.name}</p>
            </div>

            <p style="color: #6B7480; font-size: 14px;">For any queries, you can reach us at:</p>
            ...
            <p style="color: #98A0AB; font-size: 12px; margin: 0;">Placewell Careers | 39, Anand Shopping Complex, Sector 17 A, Chandigarh</p>
          </div>
        </body>
      </html>
    `;
